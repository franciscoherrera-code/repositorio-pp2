 ...
 <!-- este archivo es solo de prueba para testear por que no me mostraba las rutas -->
...
<body>
  ...
  <!-- JS de Leaflet y plugin para rutas codificadas -->
  <script src="https://unpkg.com/leaflet@1.9.3/dist/leaflet.js"></script>
  <script src="https://unpkg.com/leaflet-encoded@1.0.1/Polyline.encoded.js"></script>
  ...
  <script>
    ...
    fetch('https://api.openrouteservice.org/v2/directions/driving-car', {
      ...
      body: JSON.stringify({
        coordinates: [
          [coordenadas.origen[1], coordenadas.origen[0]], // lon, lat
    ...
    .then(data => {
      ...
      const decoded = L.Polyline.fromEncoded(encoded).getLatLngs();
